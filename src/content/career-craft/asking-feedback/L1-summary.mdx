...
Office words in the scenario:

| Term                  | Read it as                                                                   |
| --------------------- | ---------------------------------------------------------------------------- |
| Pitch deck / deck     | A presentation meant to persuade someone                                     |
| Pricing slide         | The slide that explains cost and value                                       |
| Competitor comparison | Showing how this option compares with another option the client might choose |
| Client                | The person or company Maya is trying to convince                             |
...
<LevelIntro
  items={[
    "Why the question's shape decides the answer",
    "Calibration: how much to trust an answer",
...
- **Calibration** is the separate skill of knowing how much weight to put
  on any given piece of feedback. It is not "believe them" versus "don't
  believe them"; it is more like asking how much of the work they actually
  saw before deciding how strongly to rely on their answer.
- Feedback quality also depends on **psychological safety** — feeling that
  an honest answer will not bring punishment, mockery, or defensiveness.
  Someone who believes candid criticism will be held against them gives
  safer, vaguer answers regardless of how the question is phrased; this is
  a property of the relationship and the environment, not just the
  individual question.
