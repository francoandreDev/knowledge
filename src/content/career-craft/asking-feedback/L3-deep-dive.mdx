...
<LevelIntro
  items={[
    "Three requests, same person, same deck",
    "Counting checkable claims, not word count",
    "Failure modes and how the model transfers",
  ]}
/>
...
<Checkpoint question="Jordan's answer to Request 2 named a real, specific gap. Does Maya yet know how much of the rest of the deck she can trust as fine?">

No. Request 2 tells her about the pricing slide specifically, and nothing
about anything else — Jordan could have skimmed the rest of the deck in
thirty seconds or read it word for word, and the answer would look
identical either way. A specific answer about one part of the work isn't
the same as knowing how much of the whole thing was actually reviewed;
that's a separate question Maya still has to ask.
...
<Checkpoint question="Request 3's response was the shortest of the three, at 19 words. Does that mean it carried the least information?">

No — it carried the most. Word count and information aren't the same
thing: Request 1's longer-sounding "looks great, nice work!" contains zero
checkable claims, while Request 3's short "mainly the pricing slide"
resolves exactly what Maya needed to know about coverage. A short, precise
answer with a real claim in it beats a longer, padded one with none —
length was never the thing that made a response useful.
