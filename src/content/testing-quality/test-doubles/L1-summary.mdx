...
<LevelIntro
  items={[
    "What a seam is, and why its absence makes code untestable",
    "The three kinds of test doubles: stub, fake, mock",
    "Which question each kind of double is built to answer",
  ]}
/>
