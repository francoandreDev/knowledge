...
The bar heights above are exponents, not guesses — `10.5` means roughly 3×10^10 guesses/second, `1` means about 10 guesses/second. That gap, not the algorithm names, is the entire reason "just hash it" isn't good enough advice.
