...
<LevelIntro
  items={[
    ...
    "Why repeated claims can still be one claim",
    "Signals that actually predict credibility",
  ]}
/>

## In plain words

| Term             | Plain version                                              | School-life example                                             |
| ---------------- | ---------------------------------------------------------- | --------------------------------------------------------------- |
| Primary source   | The original place that can settle the claim               | The teacher's posted schedule                                   |
| Secondary source | Someone reporting, summarizing, or repeating that original | A classmate forwarding a screenshot                             |
| Verification     | Comparing the claim with something checkable               | Opening the course page instead of trusting the group chat      |
| Corroboration    | Real independent support, not the same message copied      | Two teachers saying it separately is stronger than two forwards |
...
- **Credibility signals worth checking**, from strongest to weaker: does the information match what you can independently verify against the primary source; does the source cite/link the actual primary source checkably; is the author identifiable and relevant; how recently was it written relative to how fast the subject changes. A polished page or a confident tone is much weaker than any of those.
...
Rule of thumb: if being wrong costs little and is easy to reverse, a quick
check may be enough. If being wrong changes an important decision, costs
money, affects health, or is hard to undo, spend more effort tracing the
claim.
