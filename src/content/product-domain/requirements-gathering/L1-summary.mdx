...
Quick vocabulary before the mistake: a **ticket** is a written work
request, an **ops lead** coordinates an operations workflow, an
**admin panel** is a screen used to manage internal data, and an
**audit log** is a record of who changed what and when.
...
<LevelIntro
  items={[
    ...
    "User stories: capturing who and why",
    "Acceptance criteria as a shared checklist",
  ]}
/>
...
- **A good requirement is falsifiable** — there's a concrete way to check whether it's been met. Here, "falsifiable" does not mean "false"; it means someone can test it and get a yes/no answer. "Improve the dashboard" can't be checked; "the dashboard's initial load time should be under 2 seconds on a typical connection" can be checked, by anyone, without asking the original requester what they meant.
