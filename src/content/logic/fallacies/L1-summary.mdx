---
title: 'L1 — Two friends missed game night. Why does "commit every week, or admit it is over" feel like the only choice?'
---
...
<LevelIntro
  items={[
    ...
    "Five common patterns and their quick tells",
    "Why persuasive and valid are different questions",
  ]}
/>

None of the three speakers is being dishonest. Each message even sounds
reasonable in the moment. What's wrong isn't the honesty — it's the
_structure_ of the reasoning: the way a phrase connects reasons to a
conclusion.

Before naming a fallacy, separate three things:

| Question               | What you are looking for                        |
| ---------------------- | ----------------------------------------------- |
| What was claimed?      | The conclusion someone wants others to accept   |
| What reason was given? | The evidence, example, authority, or assumption |
| What jump was made?    | The move from reason to conclusion              |
...
- **Straw man**: arguing against a weaker, distorted version of someone's actual position, then treating that as if it refuted the real one. "So you want us to guilt-trip anyone who's ever busy?" responds to a claim nobody made — the real issue was whether to adjust expectations or try a small fix, like a reminder text, not guilt-tripping.
...
Not every either/or sentence is a fallacy. "The invite either went out or
it did not" really has two options. The fallacy appears when real
alternatives exist and the argument hides them.
