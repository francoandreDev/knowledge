...
Nothing was watching the *cluster of facts that has to stay true together*
...
- **Entity vs. value object** — an entity has identity that persists across
  ...
  contents (two `Money($10)` instances are simply *equal*, not "the same
  one").
...
- **Context mapping, one level deeper** — once contexts exist, *how* they
