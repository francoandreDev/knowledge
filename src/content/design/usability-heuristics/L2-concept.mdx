...
Consistency is about not re-learning a pattern already learned once; recognition is about not having to *remember* something without the interface's help. Both are attacks on the same cost: making the user do work the interface could have done for them.
