...
<LevelIntro
  items={[
    "What makes influence-building 'white' vs. not",
    "Reciprocity, visibility, and alliance-building as the three mechanisms",
    "The transparency test that separates legitimate from illegitimate influence",
  ]}
/>
