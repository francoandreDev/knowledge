...
<LevelIntro
  items={[
    "A year of legitimate influence-building, month by month",
    "Why the shortcut version fails even without any dishonesty",
    "Failure modes and how far the model generalizes",
  ]}
/>
...
<Checkpoint question="Every individual coffee chat B had was honest, and B genuinely did want better relationships with those senior people, not just their vote. So why did B's outreach still read as 'networking with an agenda' instead of landing the way A's help did?">

Because reciprocity and the transparency test aren't about any single conversation being honest — they're about the pattern across time. B's outreach was compressed into the one month right before the ask, which makes the whole pattern legible as aimed at that ask, regardless of how genuine any individual chat felt in isolation. Per L2's reciprocity table, help called in (or, here, help that arrives suspiciously close to an ask) retroactively reads as transactional even when nothing said was false — the giveaway isn't a lie, it's the absence of the months of daylight that would have let the pattern read as unrelated to the eventual request.
...
<Checkpoint question="The failure modes above say A's choices weren't 'random acts of kindness with zero awareness of their broader value.' Does that mean A was really just as calculating as B, only spread out over more months and better disguised?">

No — spreading a tactic out over more time doesn't change whether it depends on concealment, and that's the actual test, not how much self-awareness someone had. A could fully explain the reasoning behind every month of help — "I think this is how you build real trust with colleagues, and yes, I understand that also matters for my own standing" — and none of it would stop working once said out loud. B's outreach reads differently not because B was more self-aware or more calculating, but because it was compressed into a single month right before an ask, which is a difference in pattern and timing, not in how much either engineer understood about their own motives. Awareness of a mechanism's benefits doesn't disqualify it from being genuine.
