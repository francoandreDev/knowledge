---
title: "L2 — Telling apart legitimate ambiguity from deception"
---

import LevelIntro from "../../../components/LevelIntro.astro";
import Checkpoint from "../../../components/Checkpoint.astro";

L1 drew the basic line between withholding and lying using Priya and
Sam's "is my job safe?" question. L2 works out how to apply that line in
practice — a decision test for telling the two apart, and why timing
turns out to be a second, separate axis from truthfulness itself.

<LevelIntro
  items={[
    "The decision test: does it plant a false belief?",
    "Why the silent gray zone still needs care",
    "Timing as a lever independent of wording",
  ]}
/>
...
```mermaid
flowchart TD
    A["Someone asks\na direct question"] --> B{"Can I share\nthe full truth?"}
    B -->|Yes| C["Share it"]
    B -->|No| D{"Will my answer leave them\nbelieving something false?"}
    D -->|"No - they'll just know\nI can't say more"| E["Strategic ambiguity:\nhonest, fine"]
    D -->|"Yes - they'll walk away\nwith a wrong belief"| F{"Am I the one stating\nthe false thing?"}
    F -->|"No, just not\ncorrecting it"| G["Gray zone:\nrisky, revisit soon"]
    F -->|"Yes, I said\nthe false thing"| H["Affirmative falsehood:\ndishonest"]
```
...
<Checkpoint question="Priya tells Sam 'I can't get into specifics about org plans right now.' Two weeks later the reorg is announced and Sam finds out Priya knew the whole time. Using the 'reversible' idea above, is Priya's earlier answer still defensible, and why?">

Yes, it's defensible, because what she said was true and did not create
a false belief — it only signaled that she had more she couldn't share.
When the full story comes out, she can honestly say "I wasn't free to
say more at the time, but I never told you the opposite was true," and
that explanation holds up because nothing in it turns out to have been
false. Contrast that with "yes, totally safe": if Sam later learns that
was untrue, there's no honest way to walk it back, because the words
themselves manufactured the false belief rather than merely leaving one
unaddressed.
...
<Checkpoint question="Priya gives Sam an honest, non-misleading answer on the day he asks. Three weeks later, nothing has been said since, and Sam has since made a major decision without knowing what Priya knows. Did Priya's original answer stop being true, or did something else go wrong?">

Her original answer didn't stop being true — nothing about the wording
changed, and it still wasn't misleading at the moment she said it. What
went wrong is the second, separate question: whether she updated Sam
promptly enough for the decision he actually had to make. Truthfulness
and timing are independent obligations, and satisfying one doesn't
automatically satisfy the other. An answer that was responsible the day
it was given can still leave someone worse off later if it's left
standing past the point where circumstances, or the listener's need to
decide something, have moved on.
