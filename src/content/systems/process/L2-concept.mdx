...
On Unix-like systems (Linux, macOS), starting a program is a two-step handoff, classically called **fork + exec** — and the split between the two steps is the answer to the question above.
